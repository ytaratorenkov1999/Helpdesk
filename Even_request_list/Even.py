...
def even_request():
    ...
    for num, element in enumerate(driver.find_elements('xpath', "//tbody/tr[@class='even']"), 1):
        try:
            element.click()
        except:
            driver.find_element('xpath', f"(//tbody/tr[@class='even'])[{num}]").click()
        ...
        if name_customer_request not in \
                ('herald@aeroflot.ru', 'Гвинтовкина', 'Богинский', 'ife_ticket@rossiya-airlines.com', 'Евстигнеева',
                 'd.efremov@rossiya-airlines.com', 'Фунтов', 'N.Golikova@rossiya-airlines.com', 'Сидорова', 'ИП Кодоев',
